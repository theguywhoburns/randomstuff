...
execute if data storage randomstuff:knapping.grid.match result run function randomstuff:pattern_matching/on_match with storage randomstuff:knapping.grid.match
